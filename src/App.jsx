                ...
                {classList.length === 0 ? (
                  ...
                  classList.map(cls => (
                    <div key={cls.id} className="flex justify-between items-center p-3 bg-slate-50 rounded-lg hover:bg-slate-100 transition">
                      ...
                      <button 
                        onClick={async()=>{
                          if (confirm(`Delete ${cls.name}? This will also delete all students and subjects in this class.`)) {
                      ...
                      <div className="max-h-96 overflow-y-auto space-y-2">
                        {students.map(stu => (
                          <div key={stu.id} className="flex justify-between items-center p-3 bg-slate-50 rounded-lg hover:bg-slate-100 transition">
                            ...
                            <button 
                              onClick={async()=>{
                                if (confirm(`Delete ${stu.name}? This will also delete all their results.`)) {
