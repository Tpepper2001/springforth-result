  ...
  return (
    <div className="flex h-screen bg-slate-50">
      <div className={`fixed lg:static inset-y-0 left-0 w-72 bg-indigo-950 text-white p-6 transition-transform z-40 ${side ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
        ...
        <button onClick={onLogout} className="mt-8 flex items-center gap-3 text-red-400 font-bold p-3 hover:bg-red-400/10 rounded-xl w-full"><LogOut size={20}/> Logout</button>
      </div>
        ...
        <div className="fixed inset-0 bg-slate-900/60 flex items-center justify-center p-4 z-50">
          <div className="bg-white p-8 rounded-3xl w-full max-w-sm">
            ...
            <div className="space-y-4">
              ...
              <button onClick={() => setSelectedUser(null)} className="w-full py-4 text-slate-400 font-bold uppercase text-xs">Dismiss</button>
            </div>
          </div>
        </div>
      )}
  ...
  return (
    <div className="min-h-screen bg-indigo-50 flex items-center justify-center p-4">
      <div className="bg-white p-10 rounded-[50px] shadow-2xl max-w-md w-full border-t-8 border-indigo-600">
        ...
        <div className="flex gap-4 mb-8 border-b text-[10px] font-black uppercase pb-3 overflow-x-auto">
